...
SKYLINE.WebGLRenderer = function( parameters )
{
    ...
    this.setupMaterial = function( material )
    {
        ...
        if( type != "" )
        {
            ...
            return setProgram( program, this.__redrawNeeded, this.ctx );
        }
    }
    ...
    this.addObject = function( object, scene )
    {
        ...
        if( ! object.__webGLInit )
        {
            ...
            geometry.indexArrayNeedUpdating = true;
            geometry.colorsNeedUpdating = true;
    ...
    this.updateObject = function( object, scene, camera )
    {
        ...
        if( geometry.verticesNeedUpdating || geometry.indexArrayNeedUpdating || geometry.colorsNeedUpdating )
        {
